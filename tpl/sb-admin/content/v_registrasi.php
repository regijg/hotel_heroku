...
<div class="row">
    ...
    <form action="javascript:;" method="post" id="form_registrasi_tamu">
          ...
          <div class="col-sm-2" style="top:5px; left:-40px">
              <br>
              <button type="button" class="btn btn-xs btn-primary" onclick="setDateRange()" style="height:32px"> Search</i></button>
					</div>
          <div class="col-sm-2" style="top:5px;"></div>
          <div class="col-sm-2" style="top:5px; right:-115px">
              <br>
              <button type="button" class="btn btn-xs btn-danger" onclick="resetData(this.value)" style="height:32px"><i class="fa fa-undo"></i> Reset</button>
					</div>
          <br></br>
				</div>
        <!-- <div class="form-group">
