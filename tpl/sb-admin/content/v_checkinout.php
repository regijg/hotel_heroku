      ...
      <?=@$widget->list_room?>
	  	...
	  	<div class="modal fade" id="modal_umum">
	            ...
	            <form class="form-horizontal form-label-left" action="javascript:;" id="form_umum" method="post">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="controlsDeactive">
                                  <input class="form-control floatLabel" type="text" name="billing_no_checkout_umum" id="billing_no_checkout_umum" value="<?=$kodeunik?>" readonly placeholder="No Billing"  style="width:100px">
                            ...
                            <div class="form-group">
                              <div class="col-lg-3 col-md-5 col-sm-5">
                                <div class="controlsDeactive">
                                  ...
                                  <label for="in_date_checkout_umum_fake" class="label-date"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Tanggal Check-IN</label>
                                </div>
                              </div>
                              <div class="col-lg-3 col-md-5 col-sm-5">
                                <div class="controlsDeactive">
                                  ...
                                  <label for="out_date_checkout_umum" class="label-date"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Tanggal Check-OUT</label>
                                </div>
                              </div>

                              <div class="col-lg-2 col-md-2 col-sm-2">
                                <div class="controlsDeactive">
                                  <input type="text" class="form-control" name="out_time" id="out_time_checkout_umum" value="<?php echo date("H:i:s")?>">
                                      ...
                                      <tr id="row">
                                          ...
                                          <td>
                                            <div class="controlsDeactive">
                                              ...
                                              <input type="text" class="form-control floatLabel" id="tarif_checkout_umum_fake" readonly>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="controlsDeactive">
                                              <input type="text" class="form-control floatLabel" name="hari_checkout_umum" id="hari_checkout_umum" style="width:50px;" onkeyup="hitungTotalPembayaranKamar();" readonly>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="controlsDeactive">
                      ...
                      <div class="modal fade" id="modal_tambah_layanan">
                        <div class="modal-dialog modal-lg modal-md modal-sm">
                          <div class="modal-content">
                                      ...
                                      <table class="table table-striped" id="tabel_layanan">
                                        ...
                                        <tbody id="row_layanan">
                                              ...
                                              <tr id="row_<?= $i?>">
                                                  ...
                                                  <td><input class="form-control pmenu" type="text" style="text-align: right" name="price_menu_[]" id="price_menu_<?=$i?>" onclick="priceInput()"  placeholder="Harga"></td>
                                                  <td><input class="form-control" type="text" style="text-align: right;width:70px" name="qty_[]" id="qty_pesanan_<?=$i?>" value="0" onchange="hitungQty(this.id)"></td>
                                                  <td><input class="form-control" type="text" style="text-align: right" name="amount_[]" id="jumlah_pesanan_<?=$i?>" placeholder="Jumlah"></td>
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-success custom-close">Selesai</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-1 col-md-5 col-sm-5">
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_tambah_layanan">Tambah Layanan</button>
                            </div>
                            <div class="col-lg-4 col-md-5 col-sm-5">
                            </div>
                            <div class="col-lg-3 col-md-5 col-sm-5" style="top:6.5px">
                                <div class="controlsDeactive">
                                  <i class="fa fa-sort"></i>
                                  <select class="form-control floatLabel" id="payment_methode" onclick="peyment_method_click(this.value)" name="payment_methode" style="width:100%">
                                    <option value="tunai">Tunai</option>
                                    <option value="debit">Debit</option>
                                    <option value="kredit">Kredit</option>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-3 col-md-5 col-sm-5" style="top:6.5px">
                                <div class="controlsDeactive" id="div_deposit_tipe">
                                  <i class="fa fa-sort"></i>
                                  <select class="form-control floatLabel" id="deposit_type" onclick="deposit_type_click(this.value)" name="deposit_type" style="width:100%">
                                    <option value=""></option>
                                    <option value="tunai">Tunai</option>
                                    <option value="debit">Debit</option>
                                    <option value="kredit">Kredit</option>
                                    <option value="autodebit">Autodebit</option>
                                  </select>
                                  <label for="deposit_type">Pembayaran Deposit</label>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-7 col-sm-7" id="div_payment_total">
                                <div class="controlsDeactive">
                                  <input class="form-control payment_total_checkout_umum" type="hidden" name="payment_total_checkout_umum" onchange="hitungKembalian();"  id="payment_total_checkout_umum" style="margin-top: 6px;text-align:right; font-size:16px">
                            ...
                            <div class="col-lg-4 col-md-7 col-sm-7" id="div_deposit">
                                <div class="controlsDeactive">
                                  <input class="form-control payment_total_checkout_umum" type="hidden" name="deposit" onkeyup="hitungSisaDeposit();" id="deposit" style="margin-top: 6px;text-align:right; font-size:16px">
                                  <input class="form-control floatLabel" type="text" id="deposit_fake" style="margin-top: 6px;text-align:right; font-size:18px;">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                              ...
                              <div class="col-lg-4 col-md-7 col-sm-7" id="div_kembalian">
                                <div class="controlsDeactive">
                              ...
                              <div class="col-lg-4 col-md-7 col-sm-7" id="div_sisa_deposit">
                                  <div class="controlsDeactive">
                                    <input class="form-control" type="hidden" name="sisa_deposit" id="sisa_deposit" style="margin-top: 6px;text-align:right; font-size:16px">
                                    <input class="form-control floatLabel" type="text" id="sisa_deposit_fake" style="margin-top: 6px;text-align:right; font-size:18px;">
                                    <label for="sisa_deposit_fake"><i class="fa fa-money"></i>&nbsp;&nbsp;Sisa Deposit</label>
                                  </div>
                              </div>
                        </div>
                      </div><br>
              ...
              <div class="modal fade" id="modal_kekurangan_deposit">
                <div class="modal-dialog modal-sm modal-md modal-sm" style="top:250px">
                  <div class="modal-content">
                    <div class="modal-body">
                      <div class="row">
                          <div class="col-lg-12">
                            Maaf, pembayaran untuk autodebit tidak mencukupi !! silahkan deposit terlebih dahulu untuk pembayaran autodebit.
                          </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-2">
                          <button type="button" class="btn btn-success custom-close-deposit">Oke</button>
                        </div>
                      </div>
                    </div>
                  </div>
