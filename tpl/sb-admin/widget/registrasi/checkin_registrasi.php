...
<div class="row">
    ...
    <div class="box box-primary">
      <div class="box-header with-border" style="text-align:center">
        <h3 class="box-title">DAFTAR TAMU CHECK-IN</h3>
      </div>
      <br/>
      <div class="form-group">
        <div class="col-sm-2">
          <input onkeyup="searchDataCheckin(this.value);" type="text" name="search" class="form-control" placeholder="Nama or No-Reg">
        </div>
      </div>
      <br/>
      <div class="box-body" style="width:99%">
        <table id="jqGridDataCheckIn"></table>
